...
\begin{figure*}
    \centering
    \includegraphics[width=\textwidth]{Lit-16-TNR-HDR.png}
    \caption{\bf{
...
\begin{figure*}[t]
    \centering
    \includegraphics[width=0.85\textwidth,height=3.5in]{SimComp14-TNR.png}
    \caption{\bf{
...
\begin{figure*}
    \centering
    \resizebox{\textwidth}{!}{
    \includegraphics[width=4in]{SampRes-14-TNR.png}}
    \caption{\bf{
